...
<div class="fixed-top" id="header">
    ...
    <div id="navigation" class="row justify-content-between" style="margin-top: 5px; display: none;">
        ...
        <button class="btn col-lg-6" onClick="window.location.href = 'viewpurchase'" style="background-color: #5865F2; color:#FFFFFF; text-align: center; height: 50px; width: 49.8%; ">Purchase</button>   
