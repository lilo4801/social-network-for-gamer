                ...
                <c:forEach items="${p}" var="listP">
                    <div class="col-md-2 product">
                        ...
                        <div class="body-content">
                            ...
                            <div class="">
                                <div class="nameProduct" style="text-align: left">
...
//                                "<button id=\"creatPostbutton\"class=\"btn\">Save</button></div>\n"
                        ...
                        listOptionGame += "<select name=\"gID\" id=\"gID\">";
            <c:forEach items="${g}" var="g">
                        listOptionGame += "<option ${requestScope.product.gameID eq g.ID?"selected=\"selected\"":""} value=${g.ID}>${g.name}</option>";
            </c:forEach>
                        listOptionGame += "</select>";
                        var html = "";
                        html +=
                                "                    <div class=\"modal-header\">\n" +
                                "                            <input type=\"hidden\" name=\"uID\" value=\"" + data.UserID + "\"/>\n" +
                                "                        <h5 class=\"modal-title\" id=\"exampleModalLabel\">" + data.UserID + "</h5>\n" +
                                "                        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>\n" +
                                "                    </div>\n" +
                                "                    <div class=\"modal-body\">\n" +
